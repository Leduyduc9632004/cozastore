                    ...
                    <div class="p-r-45 p-r-0-lg">
                        ...
                        <div class="p-b-63">
                            <a href="blog-detail.html" class="hov-img0 how-pos5-parent">
                                <img src="{{asset('theme/cozastore/images/blog-04.jpg')}}" alt="IMG-BLOG">
                        ...
                        <div class="p-b-63">
                            <a href="blog-detail.html" class="hov-img0 how-pos5-parent">
                                <img src="{{asset('theme/cozastore/images/blog-05.jpg')}}" alt="IMG-BLOG">
                        ...
                        <div class="p-b-63">
                            <a href="blog-detail.html" class="hov-img0 how-pos5-parent">
                                <img src="{{asset('theme/cozastore/images/blog-06.jpg')}}" alt="IMG-BLOG">
                    ...
                    <div class="side-menu">
                        ...
                        <div class="p-t-55">
                            ...
                            <ul>
                                ...
                                <li class="bor18">
                                    <a href="{{route('client.filterByCate',$category->id)}}" class="dis-block stext-115 cl6 hov-cl1 trans-04 p-tb-8 p-lr-4">
                                        {{$category->name}}
                                    </a>
                                </li>
                                @endforeach

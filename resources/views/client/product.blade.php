            ...
            <div class="dis-none panel-filter w-full p-t-10">
                <div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm">
                    <div class="filter-col1 p-r-15 p-b-27">
                        ...
                        <ul>
                            <li class="p-b-6">
                                <a href="?sortby=default" class="filter-link stext-106 trans-04">
                                    Default
                                </a>
                            </li>

                            <li class="p-b-6">
                                <a href="?sortby=latest" class="filter-link stext-106 trans-04">
                                    Latest
                                </a>
                            </li>

                            <li class="p-b-6">
                                <a href="?sortby=lowToHigh" class="filter-link stext-106 trans-04">
                                    Price: Low to High
                                </a>
                            </li>

                            <li class="p-b-6">
                                <a href="?sortby=highToLow" class="filter-link stext-106 trans-04">
                                    Price: High to Low
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="filter-col2 p-r-15 p-b-27">
                        ...
                        <ul>
                            <li class="p-b-6">
                                <a href="?sortby=price1" class="filter-link stext-106 trans-04">
                                    0-100.000<sup>đ</sup>
                                </a>
                            </li>

                            <li class="p-b-6">
                                <a href="?sortby=price2" class="filter-link stext-106 trans-04">
                                    100.000-200.000<sup>đ</sup>
                                </a>
                            </li>

                            <li class="p-b-6">
                                <a href="?sortby=price3" class="filter-link stext-106 trans-04">
                                    200.000-300.000<sup>đ</sup>
                                </a>
                            </li>

                            <li class="p-b-6">
                                <a href="?sortby=price4" class="filter-link stext-106 trans-04">
                                    300.000-400000<sup>đ</sup>
                                </a>
                            </li>

                            <li class="p-b-6">
                                <a href="?sortby=price5" class="filter-link stext-106 trans-04">
                                    400000<sup>đ</sup> +
                                </a>
                            </li>
                        </ul>
